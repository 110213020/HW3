...
CREATE TABLE `order` (
  ...
  `evaluate` varchar(10) NOT NULL DEFAULT '未處理'
...
(1, '護手霜 * 3,', 600, '未處理', 'c1', 'm1', '未處理'),
(2, '滑鼠 * 5,', 1000, '未處理', 'c1', 'm2', '未處理'),
(3, '護手霜 * 1,', 200, '未處理', 'c2', 'm1', '未處理'),
(4, '滑鼠 * 1,', 200, '未處理', 'c2', 'm2', '未處理');
